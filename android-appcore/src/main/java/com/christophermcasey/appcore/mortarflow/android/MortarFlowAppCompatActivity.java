...
import com.christophermcasey.appcore.mortarflow.presenter.SplashPresenter;
...
import static com.christophermcasey.appcore.TypefaceUtil.spanWithTypeface;
import static com.christophermcasey.appcore.mortarflow.android.RequestPermissionService.getRequestPermissionService;
...
public abstract class MortarFlowAppCompatActivity extends AppCompatActivity
  ...
  protected void customizeMortarScope(@NonNull MortarScope.Builder builder) {
    // no-op
  }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (activityScope == null) {
      ...
      customizeMortarScope(builder);
      activityScope = builder.build(scopeName);
    } else {
