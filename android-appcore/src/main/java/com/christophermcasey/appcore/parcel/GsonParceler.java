package com.christophermcasey.appcore.parcel;
...
public class GsonParceler implements StateParceler {
  ...
  @Module
  public static class GsonParcelerModule {
    @Provides
    @Singleton
    GsonParceler provideGsonParceler(@Named("stateParcelerGson") Gson gson) {
  ...
  private GsonParceler(Gson Gson) {
    this.gson = Gson;
  }
