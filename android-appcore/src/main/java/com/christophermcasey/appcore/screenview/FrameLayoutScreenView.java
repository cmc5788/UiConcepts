 ...
 */
public abstract class FrameLayoutScreenView< //
    V extends FrameLayoutScreenView, VP extends ScreenViewPresenter<V>> //
    extends FrameLayout //
  ...
  public FrameLayoutScreenView(Context context, AttributeSet attrs) {
    super(context, attrs);
    //noinspection unchecked
    _this = (V) this;
    impl.onCreateImpl(_this, context);
  ...
  public FrameLayoutScreenView(Context context, AttributeSet attrs, int defStyleAttr) {
