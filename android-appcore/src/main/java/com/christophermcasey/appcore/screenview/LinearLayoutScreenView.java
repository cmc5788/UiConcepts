 ...
 */
public abstract class LinearLayoutScreenView< //
    V extends LinearLayoutScreenView, VP extends ScreenViewPresenter<V>> //
  ...
  public LinearLayoutScreenView(Context context) {
    super(context);
  ...
  public LinearLayoutScreenView(Context context, AttributeSet attrs) {
    super(context, attrs);
    //noinspection unchecked
    _this = (V) this;
    impl.onCreateImpl(_this, context);
  ...
  public LinearLayoutScreenView(Context context, AttributeSet attrs, int defStyleAttr) {
