 ...
 */
public abstract class RelativeLayoutScreenView< //
    V extends RelativeLayoutScreenView, VP extends ScreenViewPresenter<V>> //
  ...
  public RelativeLayoutScreenView(Context context) {
    super(context);
  ...
  public RelativeLayoutScreenView(Context context, AttributeSet attrs) {
    super(context, attrs);
    //noinspection unchecked
    _this = (V) this;
    impl.onCreateImpl(_this, context);
  ...
  public RelativeLayoutScreenView(Context context, AttributeSet attrs, int defStyleAttr) {
